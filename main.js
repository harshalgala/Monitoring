...
function cpuAverage()
{
	...
	var op = 100*(totalDifference-idleDifference)/totalDifference;
	fs.appendFile('data.txt', "CPU:"+ op + "\n", function (err) {
		if (err) throw err;
	});
